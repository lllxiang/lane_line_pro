...
void parking_space::show2()
{
    ...
    for (int i=0; i<hough_lines.size();i++)
    {
        ...
        line(img_ps_bgr, cv::Point(point1[0], point1[1]),
             cv::Point(point1[2], point1[3]), cmap[i], 1, cv::LINE_AA);
    }
    //1. IPM图中显示线段
...
parking_space::parking_space()
{
    ...
    const std::string perspectiveFileName_left = "/home/lx/data/suround_view_src_data/calibration/senyun/fish4/perspectiveTransformCalibration.txt";
